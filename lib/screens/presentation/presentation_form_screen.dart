  ...
  final List<Map<String, dynamic>> _templates = [
    {
      'key': 'corporate',
      'name': 'Obsidian Elite',
      'desc': 'Dark mode • Electric blue neon',
      'bg': const Color(0xFF080C18),
      'accent': const Color(0xFF3B82F6),
      'header': const Color(0xFF0F1729),
    },
    {
      'key': 'sunset',
      'name': 'Catalyst',
      'desc': 'Charcoal black • Vivid orange',
      'bg': const Color(0xFF0E0B08),
      'accent': const Color(0xFFF97316),
      'header': const Color(0xFF1C1007),
    },
    {
      'key': 'forest',
      'name': 'Sovereign',
      'desc': 'Deep forest • Emerald & gold',
      'bg': const Color(0xFF021C12),
      'accent': const Color(0xFF10B981),
      'header': const Color(0xFF052E1A),
    },
    {
      'key': 'royal',
      'name': 'Aurum',
      'desc': 'Midnight plum • Pure gold',
      'bg': const Color(0xFF1A0533),
      'accent': const Color(0xFFD4AF37),
      'header': const Color(0xFF2D0D4E),
    },
    {
      'key': 'minimal',
      'name': 'Vantage',
      'desc': 'Ultra-minimal • Indigo clean',
      'bg': const Color(0xFF09090B),
      'accent': const Color(0xFF6366F1),
      'header': const Color(0xFF18181B),
    },
    {
      'key': 'bold',
      'name': 'Ignite',
      'desc': 'Deep crimson • High-voltage red',
      'bg': const Color(0xFF1A0000),
      'accent': const Color(0xFFEF4444),
      'header': const Color(0xFF3B0000),
    },
  ];
            ...
            children: [
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    '6 elite templates • 45-60 word expert bullets • real data, named companies & causal analysis every slide',
